...
public class MessageBox implements Serializable , Iterable {
	/**
	 ...
	 */
	@Override
	public Iterator<? extends Message> iterator() {
		return (Iterator<? extends Message>) new MessageIterator(messages) ;
	}
}
class MessageIterator<E extends Message> implements Iterator<E> {
	private E[] messages;
